...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      fullDescription: 'Our Sustainable Agriculture Project introduces farmers to organic farming methods, water conservation techniques, and sustainable crop management. We provide training on composting, natural pest control, and efficient irrigation systems. The project also includes setting up demonstration plots and connecting farmers with organic food markets.',
      ...
      duration: '24 months',
      team: '20 volunteers',
      beneficiaries: '100+ farmers, 500+ community members',
      budget: '₹7,00,000',
      challenges: 'Resistance to change traditional methods, initial yield concerns, market price fluctuations',
      outcomes: '60% reduction in chemical fertilizer use, 30% increase in crop yield, 25 farmers certified organic'
    },
    {
      id: 4,
      ...
      fullDescription: 'This initiative focuses on educating rural communities about digital banking, mobile payments, and financial planning. We conduct workshops on using UPI, understanding bank services, and basic investment principles. The program also includes setting up digital payment systems in local shops and markets.',
      ...
      duration: '15 months',
      team: '18 volunteers',
      beneficiaries: '300+ individuals, 80+ local businesses',
      budget: '₹4,50,000',
      challenges: 'Low smartphone penetration, trust issues with digital payments, language barriers',
      outcomes: '250+ people now use digital payments regularly, 50+ shops accept digital payments, 90% reduction in cash transactions'
    },
    {
      id: 5,
      title: 'Clean Water Initiative',
      description: 'Installing water purification systems and educating communities about water hygiene.',
      fullDescription: 'Our Clean Water Initiative addresses water scarcity and quality issues in remote villages. We install solar-powered water purification systems, conduct hygiene education programs, and train local technicians for maintenance. The project also includes rainwater harvesting systems and community-managed water distribution.',
      ...
      duration: '20 months',
      team: '25 volunteers',
      beneficiaries: '500+ villagers, 3 schools, 2 health centers',
      budget: '₹8,00,000',
      challenges: 'Remote locations, technical maintenance, community ownership',
      outcomes: '100% access to clean water, 80% reduction in waterborne diseases, 10 local technicians trained'
    },
    {
      id: 6,
      title: 'Youth Skill Development',
      description: 'Providing vocational training and employability skills to unemployed youth.',
      fullDescription: 'This comprehensive program provides unemployed youth with market-relevant skills including computer literacy, communication skills, and vocational training in areas like electronics repair, mobile servicing, and digital marketing. We also provide job placement assistance and entrepreneurship support.',
      ...
      duration: '16 months',
      team: '22 volunteers',
      beneficiaries: '150+ youth, 300+ family members',
      budget: '₹6,00,000',
      challenges: 'High dropout rates, lack of motivation, limited job opportunities',
      outcomes: '120+ youth completed training, 80+ found employment, 15 started their own businesses'
    }
  ];
